<div class="modal" id="recibir_bodega" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 85%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="text" class="form-control" id="cod_envio" onchange="getOrdenRecibir()" placeholder="Código o DUI">
