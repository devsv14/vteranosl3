<!-- The Modal -->
<div class="modal" id="modal_procesando" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">    
    <div class="modal-dialog" style="max-width: 85%">
      <div class="modal-content">      
        ...
        <div class="modal-body">
          ...
          <input type="text" class="form-control" id="reg_ingresos_barcode" onchange="getOrdenBarcode()" placeholder="Busqueda por DUI">

          <button type="button" id="btn_estado" class="btn btn-default my-2 float-right btn-sm " onClick="registrarBarcodeOrdenes()" style='margin: 3px'><i class=" fas fa-file-export" style="color: #0275d8"></i> Registrar</button>
