...
function get_table_acciones(){
  ...
  console.log(codigo,dui_paciente)
  $.ajax({
    url: "../ajax/ordenes.php?op=ver_historial_orden",
    method: "POST",
...
function view_form_orden_cita(){
  let btn_switch_edit = document.getElementById('ediccion_orden_citas').checked;
  let form_edit = document.getElementById('show_form_manual')
  let dt_view = document.getElementById('tables_cita')
  let btnBuscarCitado = document.getElementById('btnBuscarCitado')
  
  //Is true active form
  if(btn_switch_edit){
    form_edit.style.display = "block"
    dt_view.style.display = "none"
    btnBuscarCitado.style.display = "none"
    document.getElementById('select_manual').style.display = "none"
    document.getElementById('select_cita').style.display = "block"
  }else{
    form_edit.style.display = "none"
    dt_view.style.display = "block"
    btnBuscarCitado.style.display = "block"
  }
