...
?>
  ...
  <body class="hold-transition sidebar-mini layout-fixed" style='font-family: Helvetica, Arial, sans-serif;'>
      ...
      <div class="content-wrapper">
        <section class="content">
          ...
          <div class="card  card card-info card-outline px-3">
              ...
              <table width="100%" class="table-responsive-sm table-hover table-bordered" id="dt-precio-ordenes" data-order='[[ 0, "asc" ]]'>
    ...
    <script type="text/javascript" src="../js/precios.js?v=<?php echo rand() ?>"></script>
