...
?>
    ...
    <head>
        ...
        require_once("../modales/bodega_av_plus/modal_ordenes_reenvio.php")
        ?>
        <style>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-end">
                                <button class="btn btn-outline-success ml-2" class="btn btn-info barcode_actions" data-toggle="modal" data-target="#modal_procesando" onClick='input_focus_clearb()'><i class="fas fa-plus"></i> Devoluciones</button>
                            </div>
                            <div class="card-body">
                                <table width="100%" class="table-hover table-bordered" id="ordenes-reenvio" data-order='[[ 0, "desc" ]]'>
