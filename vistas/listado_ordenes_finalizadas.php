...
$codigos = $_POST["ordenes_imp_finish"];
...
<html>
  ...
  .encabezado{
	...
	<body>
	 <h5 style="font-size: 14px;text-align: center;">ORDENES FINALIZADAS AL <?php date_default_timezone_set('America/El_Salvador'); $hoy = date("d-m-Y H:i:s"); echo $hoy;?></h5>
