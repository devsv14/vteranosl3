...
<body>
 ...
 <b><h5 style="font-size:12px;font-family: Helvetica, Arial, sans-serif;text-align: center;margin-bottom: 0px"> AROS SELECCIONADOS DICIEMBRE 2021 A MAYO 2022</h5></b>
  ...
  foreach ($data as $value) { ?>
    <tr>     
     ...
     <td><img src='images/<?php echo $value["img"]?>'  width="150" height="100" style="margin-top: 7px"></td>
    </tr> 

  <?php $i++; $contador=$contador+$value["cant"]; }  ?>  
  </table>
  <?php echo "TT".$contador;?>
</body>
</html>
