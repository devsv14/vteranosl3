...
?>
  ...
  <head>
    ...
    <title>INABVE - Actas l1</title>

    <?php
     require_once('../modales/licitacion1/modalSubirActas.php');
     require_once('../modales/licitacion1/modalOpenPDFActas.php');
  ...
  <body class="hold-transition sidebar-mini layout-fixed" style='font-family: Helvetica, Arial, sans-serif;'>
    ...
    <script type="text/javascript" src="../js/actas_licitacion1.js?v=<?php echo rand() ?>"></script>
