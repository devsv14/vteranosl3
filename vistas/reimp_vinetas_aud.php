...
$dui =  $data[$i];
$resultado = $reporteria->getDataOrdenDui($dui);
 
    
  $code = $Bar->getBarcode($dui, $Bar::TYPE_CODE_128,'1','45');
  ...
  if($i % 2 == 0){
    ...
    echo "<table class='table2' width='100%' style='margin-top;0px !important;margin-left:5px'>";
    echo "
     <tr>
      <td colspan='30'>
    ...
    foreach ($resultado as $key) {
      //$data_aro = $reporteria->getDataAroL1($dui);
    ...
    <tr>
      <td colspan='15' class='stilot1' style='height:22px'><b>OD</b></td>
    ...
    <tr>
      <td colspan='15' class='stilot1' style='height:22px'>".$key["pupilar_od"]." mm</td>
    ...
    <tr>
    <td colspan='100' class='stilot1' style='height:30px'>".''."</td>
    </tr>
    <tr>    
      <td colspan='100' class='stilot1'>".$data_aro."</td>
    </tr>
